...
const shows = [
  {
    ...
    desc: "El periodístico de la mañana del streaming en Uruguay: análisis político dinámico, entrevistas a todo el arco político y el humor justo para arrancar el día informado. Tercera temporada al aire.",
    image: posterCampana,
