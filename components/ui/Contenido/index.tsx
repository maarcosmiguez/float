...
import bufete1 from "public/bufete-1.jpg";
    ...
    <div className="mx-auto my-auto min-h-screen flex flex-col gap-10 relative z-10 justify-center max-w-screen-4xl ">
        ...
        <div className="mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          <div className="flex-none space-y-0 sm:space-y-1 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            ...
            <h4 className="text-gray-200 font-bold text-lg xl:text-2xl hidden sm:block">
              con Marcos Casas y Fer Kosak
            </h4>
            <p className="text-gray-300 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
              El streaming que le faltaba a esta campaña electoral. Información, opinión, frescura, encanto, entrevistas, y muchas cosas más que nuestras mamás nos dijeron que tenemos. Tal vez nos recuerdes de algún clip que te pasaron para pegarle al Boca o a Sanjurjo. 
            </p>
          </div>
          <a
          ...
          >
            <Image src={cdm1} className=" md:rounded-tl-[108px] px-4" alt="" />
      ...
      <article id="bufete">
        <div className="mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:flex-row-reverse md:px-8">
          <div className="flex-none space-y-0 sm:space-y-1 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            <h1 className="text-sm text-indigo-400 font-medium">Viernes 20h</h1>
            <h2 className="font-bold text-2xl py-2 sm:py-0 sm:text-4xl heading text-white xl:text-5xl">
              Bufete Sentimental
            </h2>
            <h4 className="text-gray-200 font-bold text-lg xl:text-2xl hidden sm:block">
              con Fer Kosak e Irene Dalponte
            </h4>
            <p className="text-gray-300 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
            El podcast de cornudas menos cornudo que vas a escuchar. Abordamos temas lindantes al amor pero con una perspectiva académica, política, social que te va a hacer decir ¿cómo son tan graciosas, inteligentes, ocurrentes y lindas de cara? Increíble pero es así.
            </p>
          </div>
          <a
            className="flex-none mt-2 md:mt-0 md:max-w-lg px-4 relative"
          ...
          >
            <Image src={bufete1} className=" md:rounded-tl-[108px] px-4" alt="" />
            <div className="hidden md:flex absolute top-[15px] right-[50px] w-10 h-10 items-center overflow-hidden justify-center rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
              <svg
                className="fill-gray-900 relative z-10 transition-all duration-300 group-hover:fill-white"
                xmlns="http://www.w3.org/2000/svg"
